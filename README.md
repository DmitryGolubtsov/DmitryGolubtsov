...
|[Анализ продуктовых метрик сервиса по доставку с использованием когортного анализа](https://github.com/DmitryGolubtsov/delivery_service_analytics)|Разбивка пользователей на когорты по дате регистрации и покупки, рассчет и анализ MAU, ROMI, Conversion Rate.|**Pandas** **Seaborn** **Requests**|
